...
<div class="w-full mx-auto overflow-y-hidden max-w-7xl" x-data="{ view: 'list' }">
    ...
    <flux:tabs variant="segmented" size="sm" class="mt-4" wire:model.live='view'>
        <flux:tab icon="squares-2x2" name="list">Grid</flux:tab>
    ...
    @if ($view === 'table')
        <div class="rounded-xl bg-slate-50 dark:bg-slate-900 p-1 shadow-inner mt-4">
            <div class="rounded-lg rounded-b-lg bg-white dark:bg-slate-800/50 shadow-xs-with-border px-3.5 m-0.5">
                <div class="p-2 pb-4">
                    <flux:table :paginate="$vault_records">
                        <flux:table.columns>
