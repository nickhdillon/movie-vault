...
<div class="w-full mx-auto max-w-7xl">
    ...
    <flux:input icon="magnifying-glass" placeholder="Search..." clearable
        wire:model.live.debounce.300ms='search' class="mt-5" />
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3 py-3">
        @forelse ($this->searchResults as $media)
            @isset($media['original_language'])
                <div
                    class="rounded-[12px] bg-white dark:bg-gray-800/70 shadow-xs border dark:border-gray-700 border-gray-200 px-[5px] pt-[5px]">
                    ...
                    <div class="p-3 text-sm dark:bg-transparent rounded-b-lg space-y-1">
        ...
        @empty
            <div class="col-span-3 mt-1 mx-auto text-center">
                <h1 class="text-md font-medium text-gray-500" wire:loading.remove>
