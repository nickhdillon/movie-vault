...
<div class="w-full mx-auto overflow-y-hidden max-w-7xl">
    ...
    <div class="rounded-lg border dark:bg-slate-900 border-slate-200 dark:border-slate-700 mt-4 bg-slate-50">
        ...
        <div class="rounded-t-lg rounded-b-lg bg-white dark:bg-slate-800/50 px-4 dark:border-slate-700 border-slate-200 @if (count($vault_records) > 0) mt-4 border-t @else border-none @endif"
